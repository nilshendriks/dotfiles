return {
    {
        ...
        dependencies = {
            ...
            "hrsh7th/cmp-emoji", -- Keep emoji completion
            "saadparwaiz1/cmp_luasnip", -- To integrate LuaSnip with nvim-cmp
        },
        opts = function(_, opts)
            -- Add the emoji source
            table.insert(opts.sources, { name = "emoji" })
            -- Add other sources for completion
            table.insert(opts.sources, { name = "nvim_lsp" })
            table.insert(opts.sources, { name = "luasnip" }) -- Add snippet support
