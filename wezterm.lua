...
wezterm.on("gui-startup", function(cmd)
	...
	leftR:send_text("ssh mini -t 'zsh -i -l -c \"cd /Users/henk3d/HENK-3D/henk-render && crush; exec $SHELL\"'\n")
	local rightR = leftR:split({ direction = "Right", size = 0.5 })
	rightR:send_text("ssh mini -t 'zsh -i -l -c \"cd /Users/henk3d/HENK-3D/henk-render && nn .; exec $SHELL\"'\n")
	leftR:activate()
